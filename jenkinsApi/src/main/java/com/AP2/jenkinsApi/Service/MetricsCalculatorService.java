...
import com.AP2.jenkinsApi.Interface.IMetricsService;
import com.fasterxml.jackson.databind.JsonNode;

import java.sql.*;
import java.time.Instant;

public class MetricsCalculatorService implements IMetricsService {
    ...
    @Override
    public int calculateDeploymentFrequency(String jobName) throws Exception {
        ...
        try (Connection connection = databaseClient.getConnection();
            ...
            preparedStatement.setLong(2, Instant.now().minusSeconds(7 * 24 * 3600).toEpochMilli());
    ...
    @Override
    public long calculateLeadTimeForChanges(String jobName) throws Exception {
    ...
    @Override
    public double calculateChangeFailureRate(String jobName) throws Exception {
    ...
    @Override
    public double calculateTimeToRestoreService(String jobName) throws Exception {

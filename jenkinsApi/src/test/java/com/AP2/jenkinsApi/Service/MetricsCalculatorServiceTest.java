...
class MetricsCalculatorServiceTest {
    ...
    void testCalculateLeadTimeForChanges() throws Exception {
        ...
        assertEquals(10, leadTime);  // Expected 10 minuten
    ...
    void testCalculateTimeToRestoreService() throws Exception {
        ...
        double timeToRestore = metricsCalculator.calculateTimeToRestoreService(jobName);
        assertEquals(30, timeToRestore);  //30 minuten
